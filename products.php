    ...
    <div class="main row">
       <section class="main col">
            ...
            <div class="tab-pane active" id="tab1">
                <a href="#" rel="tooltip" title="Pictured is a Fligh Simulator developed by us."><img src="images/17.jpg" class="pull-right" alt="Flight Simulator"/></a>
              <p> Leads has extensive knowledge and experience in building Flight Simulators for professional and hobby applications.  Some of our products are serving to help understanding of aircraft and its flying characteristics for budding aeronautical students. 
              These simulators are built using COTS items and integrated with Open Source software which resulted in quite cost effective simulators for the institutions.
              </p>
            </div>
            <div class="tab-pane" id="tab2">
            <span class="pull-right">
              <img src="images/18s1Set.jpg" alt="Push button switches">
            </span>
            <p>Push button switches are quite common in modern commercial aircrafts.  These widely used switches are supplied by others at a premium price.  Leads has taken up a project to design and develop a airborne push button switch which can be qualified as per MIL 810F standard for type certification.  Currently it is under development and expected to be certified by CEMILAC by mid 2014.</p>
              <span class="pull-right">
                <img src="images/18s2Set.jpg" alt="Push button switches cum Indicators">
              </span>
            </div>
            <div class="tab-pane" id="tab3">
            <span class="pull-right">
              <img src="images/19.jpg" alt="1553b Cards">
            </span>
            ...
            <span class="pull-right">
              <img src="images/WindTunnels.jpg" alt="Wind Tunnel Testing">
            </span>
